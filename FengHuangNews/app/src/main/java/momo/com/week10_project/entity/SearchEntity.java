...
public class SearchEntity {
    ...
    private TdataEntity tdata;
    private List<DataEntity> data;
    private List<VdataEntity> vdata;

    public void setChanneldata(ChanneldataEntity channeldata) {
        this.channeldata = channeldata;
    }

    public void setTdata(TdataEntity tdata) {
        this.tdata = tdata;
    }
    ...
    public void setVdata(List<VdataEntity> vdata) {
        this.vdata = vdata;
    }
    ...
    public List<VdataEntity> getVdata() {
        return vdata;
    }
    ...
    public static class TdataEntity {
        /**
         * type : tag
         * title : 大家都在搜
